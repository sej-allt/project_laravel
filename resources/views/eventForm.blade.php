    ...
    <form action="{{url('/individualReg')}}" class="mx-auto px-3" method="POST">
        ...
        <div class="mb-5">
            ...
            <div class="relative">
                ...
                <input type="text" class="form-control rounded-[20px] bg-gray-50 text-sm w-full" name="event_name" id="event_name" placeholder="Enter Event Name" value="{{old('event_name')}}" required>
            </div>
