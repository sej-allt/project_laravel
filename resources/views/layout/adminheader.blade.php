        ...
        <div class="flex h-12 items-center justify-between">
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="{{route('events')}}" class="{{Request::is('events')?'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}} hover:no-underline rounded-md px-3 py-2 text-sm font-medium">Events</a>
                @yield('navbar')
          ...
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              <a href="{{route('viewRequests')}}"><button type="button"  class="relative rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
