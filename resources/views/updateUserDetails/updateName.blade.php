...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    {{-- <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Update Name</h2>
    </div> --}}

    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
     <form action="{{ route('updateUserDataName') }}" method="POST">
            ...
            <div class="mb-4">
                <label for="student_name" class="block text-sm font-medium leading-6 text-gray-900">New Name</label>
                <input id="student_name" name="student_name" type="text" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
