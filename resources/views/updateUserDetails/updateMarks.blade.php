...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form action="{{route('reqAdmin') }}" method="POST" enctype="multipart/form-data">
            @csrf
...
<option value="10th Semester">10th Semester</option>
     ...
     <div class="mb-4">
    <label for="pdf_document" class="block text-sm font-medium leading-6 text-gray-900">Upload PDF Document</label>
    <input id="pdf_document" name="pdf_document" type="file" accept=".pdf" required class="block w-full py-1.5 text-gray-900 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6">
</div>
            <div>
